...
{
	return m_EnemyHithNode;
}

PlayerDetectedCondition* DecisionTree::GetPlayerDetectionNode() const
{
...
void DecisionTree::SetEnemyHithNode(EnemyHitCondition* node)
{
	m_EnemyHithNode = node;
}
